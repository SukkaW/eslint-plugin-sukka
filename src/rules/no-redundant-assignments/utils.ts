...
export class ReachingDefinitions {
  ...
  in: Map<TSESLint.Scope.Variable, Values> = new Map<TSESLint.Scope.Variable, Values>();

  out: Map<TSESLint.Scope.Variable, Values> = new Map<TSESLint.Scope.Variable, Values>();

  /**
   * collects references in order they are evaluated, set in JS maintains insertion order
   */
  references: Set<TSESLint.Scope.Reference> = new Set<TSESLint.Scope.Reference>();
...
export class AssignmentContext {
  ...
  public lhs: Set<TSESLint.Scope.Reference> = new Set<TSESLint.Scope.Reference>();
  public rhs: Set<TSESLint.Scope.Reference> = new Set<TSESLint.Scope.Reference>();
